defmodule PokemonDemoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PokemonDemoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PokemonDemoWeb.Gettext, "errors", msg, opts)
    end
  end
